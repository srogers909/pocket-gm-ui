...
class PlayerDetailsCard extends StatelessWidget {
  ...
  Widget _buildPositionRatings() {
    ...
    return Wrap(
      ...
      runSpacing: 8,
      children: [
        _buildRatingChip(attributes.attribute1, player.positionRating1),
        _buildRatingChip(attributes.attribute2, player.positionRating2),
        _buildRatingChip(attributes.attribute3, player.positionRating3),
      ],
    );
  }
        ...
        children: [
          ...
          _buildSection(
            ...
            Wrap(
              ...
              runSpacing: 8,
              children: [
                _buildRatingChip('Overall', player.overallRating),
                _buildRatingChip('Potential', player.potentialRating),
                _buildRatingChip('Durability', player.durabilityRating),
                _buildRatingChip('Football IQ', player.footballIqRating),
                _buildRatingChip('Fan Popularity', player.fanPopularity),
                _buildRatingChip('Morale', player.morale),
              ],
            ),
          ),
